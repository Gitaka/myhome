...
$("#clearall").change(function(){
   ...
   $("#ab1").change(function(){
	      ...
	      $.ajax({
				type:"POST",
				url:BASE_URL+"agent_rent_apartmentrooms",
	...
	$("#house").change(function(){
	 ...
	 $("#hb1").change(function(){
   	  if($(this).is(":checked")){
			$.ajax({
				type:"POST",
				url:BASE_URL + "agent_rent_houserooms",
  ...
  $("#hb5").change(function(){
   ...
   $("#hb6").change(function(){
     ...
     $("#drive").change(function(){
			...
			$.ajax({
				type:"POST",
				url:BASE_URL + "agent_rent_outsidespace",
     ...
     $("#pre").change(function(){
			...
			$.ajax({
				type:"POST",
				url:BASE_URL + "agent_rent_status",
