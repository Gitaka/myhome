...
<html>
   ...
   <body>
     ...
     <div class="container-post">
            <div id="head">Blog Post</div>
      <div id="section">
            @foreach($post as  $post)
   
           <div id="pic">
        
            <img src="{{asset($post->imgpath)}}" title="logo" "width=100% height=95%" />
          </div>
         <div id="blog_body">
         <label style="font-size:135%;font-weight:normal">
          <label style="color:#0066ff;font-weight:normal;font-size:150%;">{{$post->title}}</label>
         </label></br>
          {{nl2br($post->post)}}</br></br></br>
           <i class=" fa fa-tags " >&nbsp;&nbsp;</i>
         <label style="color:#FFC809;font-weight:normal">Category:</label>{{$post->category}}</br>
          <i class=" fa fa-calendar " >&nbsp;&nbsp;</i>
         <label style="color:#FFC809;font-weight:normal">PostedOn:</label>{{$post->created_at}}</br>
         </div>
        ...
        <div class="widget_1">
           ...
           <div id="widgetBody">
             @foreach($latest as $latest)
              ...
              <label style="font-size:120%;font-weight:normal">
         ...
         <div class="widget_2">
          ...
          <div class="widget_3">
             ...
             <div id="widgetBody4">
               ...
               </br><input type="checkbox"> <label style="font-size:50%;">You Agree to Terms Of Use And Privacy
             </label>
