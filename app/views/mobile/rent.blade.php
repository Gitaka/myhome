                   ...
                   <div id="property">
                       <div id="pic">
                          ...
                          ?>
                            ...
                            @endfor
<img src="{{asset($rent->photo).'/'.$images[0]}}" title="property photo"style="width:100%;height:90%"/>
                      </div>
                      <div id="info">
                       <p style="color:#026660">{{$rent->location}},
                         {{$rent->name}}</p>
    <p>KSH {{$rent->price}} &nbsp;&nbsp;{{HTML::linkRoute('viewrent','View Property',array($rent->id))}}</p>
                      </div>
                   </div>
                   @endforeach
              </div>
