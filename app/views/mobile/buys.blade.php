                   ...
                   <div id="property">
                       <div id="pic">
                          ...
                          ?>
                            ...
                            @endfor
<img src="{{asset($buy->photo).'/'.$images[0]}}" title="property photo"style="width:100%;height:90%"/>
                      </div>
                      <div id="info">
                       <p style="color:#026660">{{$buy->location}},
                         {{$buy->name}}</p>
        <p>KSH {{$buy->price}} &nbsp;&nbsp;{{HTML::linkRoute('viewbuy','View Property',array($buy->id))}}</p>
                      </div>
                   </div>
                   @endforeach
              </div>
