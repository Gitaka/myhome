                   ...
                   <div id="property">
                       <div id="pic">
                          ...
                          ?>
                            ...
                            @endfor
<img src="{{asset($land->photo).'/'.$images[0]}}" title="property photo"style="width:100%;height:90%"/>
                      </div>
                      <div id="info">
                       <p style="color:#026660">{{$land->location}},
                         {{$land->name}}</p>
                       <p>KSH {{$land->price}} &nbsp;&nbsp;{{HTML::linkRoute('viewland','View Property',array($land->id))}}</p>
                      </div>
                   </div>
                   @endforeach
              </div>
