   ...
   <body>
         ...
         <div class="wrapper">
          <div class="header" id="top">
            <div class="wrap">
                <!---start-logo-->
             <div class="logo">
                  <a href="/"><img style="width:100%;height:100%"src="{{$logo}}" title="logo" /></a>
             </div>
                <!--End-logo-->
      ...
      <input type="checkbox" id="apartment" name="apartment"><label class="label-style">Apartment</label></br>
       ...
       <div class="sidebar-content">
           <div class="sidebar-content-head-section" style="background-color:#fff;padding-top:0.5%;padding-left:5%;">
                  Agents:<label style="color:#336666;font-weight:normal;font-size:120%">{{$username}}</label></br>
                  Location:<label style="color:#336666;font-weight:normal;font-size:120%">{{$location}}</label></br>
                  Contacts:<label style="color:#336666;font-weight:normal;font-size:120%">{{$email}},</label>&nbsp;&nbsp;
                  <label style="color:#336666;font-weight:normal;font-size:120%">0{{$mobile}}</label>
           </div>
