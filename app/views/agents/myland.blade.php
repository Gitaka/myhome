                   ...
                   <div id="vertical-nav" class="col-sm-2">
                      ...
                      <div id="menu">
                          <ul> 
                               ...
                               <li class="vertical-active">{{HTML::linkRoute('myland','View Land')}}</li>
                               ...
                               <div id="listing-photo" class="col-sm-4">
                                             <?php
                                               ...
                                               ?>
                                                  ...
                                                  @endfor
                              <img class="img-rounded"src="{{asset($land->photo).'/'.$images[0]}}" width="250px" height="150px">
                               </div>
                               <div id="listings-name" class="col-sm-6">
                                 <label id="listing-style">Property Name : </label>{{$land->name}}</br>
                                 <label  id="listing-style">Property Location : </label>{{$land->location}}</br>
                                 <label  id="listing-style">Property Price: </label>{{$land->price}}</br></br>
                                 <label  id="listing-style">Property Created At : </label>{{$land->created_at}}
                               </div>
