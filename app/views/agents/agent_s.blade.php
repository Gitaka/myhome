...
<html>
   <head>
      ...
      <link rel="stylesheet" href="{{asset('css/test2.css')}}">
       ...
       <script src="{{asset('js/AgentBuySearch.js')}}"></script>
   </head>
   <body>
   </body>
         <div class="wrapper">
      ...
      <form>
         <div class="filter-all">
          ...
          <input type="checkbox" id="clearall"><label class="label-style">Clear All Filters</label></br>
         </div>
        <div class="filter-recent">
               <label class="label-style">Recently Addeded</label></br>
      ...
      <input type="checkbox" id="apartment" name="apartment"><label class="label-style">Apartment</label></br>
             <div class="apartment-indent"><label class="label-style">No of Bedrooms</label></br>
                <input id="ab1"type="checkbox">1</br>
