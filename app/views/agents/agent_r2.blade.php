...
<html>
   <head>
      ...
      <link rel="stylesheet" href="{{asset('css/test2.css')}}">
       ...
       <script src="{{asset('js/AgentRentSearch.js')}}"></script>
   </head>
   <body>
   </body>
         <div class="wrapper">
      ...
      <form>
         <div class="filter-all">
          ...
          <input id="clearall"type="checkbox"><label class="label-style">Clear All Filters</label></br>
         </div>
      ...
      <input type="checkbox" id="apartment" name="apartment"><label class="label-style">Apartment</label></br>
        ...
        @foreach(array_chunk($rents->all(),4) as $row)
