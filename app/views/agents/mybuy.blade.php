                   ...
                   <div id="vertical-nav" class="col-sm-2">
                      ...
                      <div id="menu">
                          <ul> 
                               ...
                               <li  class="vertical-active">{{HTML::linkRoute('mybuy','View Buy')}}</li>
                               ...
                               <div id="listing-photo" class="col-sm-4">
                                             <?php
                                               ...
                                               ?>
                                                  ...
                                                  @endfor
                              <img class="img-rounded" src="{{asset($buy->photo).'/'.$images[0]}}" width="250px" height="150px">
                               </div>
                               <div id="listings-name" class="col-sm-6">
                                 <label id="listing-style">Property Name : </label> {{$buy->name}}</br>
                                 <label  id="listing-style">Property Location : </label> {{$buy->location}}</br>
                                 <label  id="listing-style">Property Price: </label> KSH {{$buy->price}}</br></br>
                                 <label  id="listing-style">Property Created At : </label> {{$buy->created_at}}
                               </div>
